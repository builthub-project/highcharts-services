...
as sub1 on main.pop_nuts_name=sub1.name

WHERE
main.name=$P{COUNTRY} and pop_nuts_level=$P{NUTS} and topic_type=$P{TOPIC} and pop_nuts_name IN ($P{REGION}) and pop_year IN ($P{YEAR})

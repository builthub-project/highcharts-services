...
left join(
SELECT
sum(COALESCE(total_adjusted_energy_consumption_mwhperyear, 0)) as apartments
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(total_adjusted_energy_consumption_mwhperyear, 0)) as closed
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(total_adjusted_energy_consumption_mwhperyear, 0)) as halfopen
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(total_adjusted_energy_consumption_mwhperyear, 0)) as open
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT

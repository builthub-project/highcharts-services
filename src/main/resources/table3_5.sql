...
left join(
SELECT
sum(COALESCE(adjusted_reduction_potential_per_number_of_housing_units_mwhperyear, 0)) as others
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(adjusted_reduction_potential_per_number_of_housing_units_mwhperyear, 0)) as apartments
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(adjusted_reduction_potential_per_number_of_housing_units_mwhperyear, 0)) as closed
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(adjusted_reduction_potential_per_number_of_housing_units_mwhperyear, 0)) as halfopen
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT
...
left join(
SELECT
sum(COALESCE(adjusted_reduction_potential_per_number_of_housing_units_mwhperyear, 0)) as open
FROM
"public"."dashboard_be_reel" as submain
right join(
    SELECT

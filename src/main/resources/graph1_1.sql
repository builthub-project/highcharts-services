SELECT  DISTINCT
main.construction_period as "Period", sub2.closed as "Terraced", sub3.halfopen as "Semi-detached", sub4.open as "Detached", sub1.apartments as "Apartments", sub0.others as "Others"
FROM
